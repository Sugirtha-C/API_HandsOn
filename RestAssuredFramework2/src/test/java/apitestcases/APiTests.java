...
public class APiTests {
	...
	@Test
	public void validatingBookingSchema() {
		Response response = UserEndPoints.getBooking("1");
		assertEquals(response.getStatusCode(), 200);
		response.then().assertThat().body(matchesJsonSchemaInClasspath("Booking.json"));
	}
